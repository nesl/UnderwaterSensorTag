...
BOOLEAN CdcToHostFromBuffer(BYTE);
BOOLEAN CdcToBufferFromHost(BYTE);
BOOLEAN CdcIsReceiveInProgress(BYTE);
BOOLEAN HidToHostFromBuffer(BYTE);
BOOLEAN HidToBufferFromHost(BYTE);
BOOLEAN HidIsReceiveInProgress(BYTE);
extern WORD wUsbHidEventMask;
BOOLEAN PHDCToHostFromBuffer(BYTE);
BOOLEAN PHDCToBufferFromHost(BYTE);
BOOLEAN PHDCIsReceiveInProgress(BYTE);
/*----------------------------------------------------------------------------+
| General Subroutines                                                         |
+----------------------------------------------------------------------------*/
