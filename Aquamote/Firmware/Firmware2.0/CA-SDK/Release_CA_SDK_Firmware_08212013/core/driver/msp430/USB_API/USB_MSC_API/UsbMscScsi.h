...
struct _MscState {
    ...
    BOOLEAN bMcsCommandSupported;  /*Flag to indicate read/write command is recieved from host */
    BOOLEAN bMscCbwReceived;       /*Flag to inidicate whether any CBW recieved from host*/
    BOOLEAN bMscSendCsw;
    BOOLEAN isMSCConfigured;
    BYTE bUnitAttention;
    BYTE bMscCbwFailed;
