...
file_name = open("/Users/eunsunlee/Documents/NESL/UnderwaterSensorTag/IMU_GPS_Fusion/Trajectory_Simulation/simulated_position_rotation_fromblender/position_rotation_from_blender.txt", "w")
for f in range(sce.frame_start, sce.frame_end+1):
    sce.frame_set(f)

    if f <= sce.frame_end+1: 
        print("frame:",f)
