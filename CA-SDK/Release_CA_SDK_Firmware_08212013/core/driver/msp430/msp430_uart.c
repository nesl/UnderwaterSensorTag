...
int msp430_uart_init(void)
{
    ...
    /* Use SMCLK clock (default at 12MHz by CA-SDK design). */
    CTL1 |= UCSSEL_2;
...
/* Change baud rate for UART*/
int msp430_uart_br460800(void){
	/* Enable reset. */
	CTL1 |= UCSWRST;
    /* Use auxiliary clock. */
    CTL1 |= UCSSEL_2;

    /* Set baud rate to 460800 (see MSP430x5xx datasheet). */
    BR0 = 26;
    BR1 = 0;
    MCTL =0;
