...
//0x06: MODE: initiates quick-start, reports hibernate mode, and enables sleep mode
//0x16: CRATE: approximate charge or discharge rate of the battery
#define MAX17048_SLAVE_ADDR     0x36        //0110110
#define MAX17048_VCELL          0x02        //ADC measurement of VCELL
#define MAX17048_SOC            0x04        //Battery state of charge
#define MAX17048_VER            0x08        //IC production version
#define MAX17048_HIBRT          0x0A        //controls thresholds for entering and exiting hibernate mode
#define MAX17048_CONFIG         0x0C        //compensation to optimize performance, sleep mode, alert indicators, and configuration
#define MAX17048_OCV            0x0E
#define MAX17048_VLRT           0x14        //configures the VCELL range outside of which alerts are generated
#define MAX17048_VRESET         0x18        //configures VCELL threshold below which the IC resets itself, ID is a one-time factory-programmable identifier
#define MAX17048_STATUS         0x1A        //indicates overvoltage, undervoltage, SOC change, SOC low, and reset alerts
#define MAX17048_UNLOCK         0x3E
#define MAX17048_TABLE          0x40        //to 0x7F configures battery parameters
#define MAX17048_RCOMPSEG1      0x80
#define MAX17048_RCOMPSEG2      0x90
#define MAX17048_CMD            0xFE
#define MAX17048_UNLOCK_VALUE   0x4a57
#define MAX17048_RESET_VALUE    0x5400      //writing this to register causes the device to completely reset as if power had been removed
