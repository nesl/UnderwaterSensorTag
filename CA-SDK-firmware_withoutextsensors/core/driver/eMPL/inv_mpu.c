 ...
 *                  \n The following configurations are unsupported, so try
 *                  them at your own risk:
 *                  \n MPU6050 w/ AK8963 on the auxiliary bus
 *                  \n MPU6500 w/ AK8975 on the auxiliary bus
 */
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
...
#define MPU6500_MEM_REV_ADDR    (0x17)
    if (mpu_read_mem(MPU6500_MEM_REV_ADDR, 1, &rev))
        return -1;
	/* This is for product control for wrong parts or variant.
	 * If confident the part works with DMP,
	 * please modify to include to pass this step
	 * right now making it <=10 but modify accordingly.
	 * */
    if (rev<=10) {
        st.chip_cfg.accel_half = 0;
    }
